...
<?= csrf_field(); ?>
<input type="hidden" name="idsatuan" value="<?= $id; ?>">
<div class="form-group">
    <label for="namasatuan">Nama Satuan</label>
    <input type="text" name="namasatuan" id="namasatuan" class="form-control" placeholder="Isikan Nama Satuan" value="<?= $nama; ?>"autofocus>
...
$(document).ready(function() {
    $('.tombolSimpan').click(function (e) { 
        ...
        $.ajax({
            type: "post",
            url: "<?= site_url('satuan/updatedata') ?>",
            data: data,
            dataType: "json",
            processData: false,
            contentType: false,
